...
def portfolio(username):
    ...
    if profitlosssum:
        ...
        return render_template("app_pages/portfolio.html", rows=rows,
                               sumlist=sumlist)  # all the entries are stored in b and sent to the template
    else:
        msg = "no record found"
        return render_template("app_pages/portfolio.html",
                               error=msg)  # all the entries are stored in b and sent to the template
